...
```javascript
// Default secure password (16 chars, all character types)
...
```javascript
// Default: 4 words + number, separated by dashes
...
|--------|--------|-------------|
| **Length** | 30% | Character count (8+ chars recommended) |
| **Variety** | 28% | Mix of uppercase, lowercase, numbers, symbols |
| **Patterns** | 20% | Absence of predictable sequences |
| **Commonality** | 15% | Not found in common password lists |
| **Breach Status** | 7% | Not found in breach databases |
...
|-------------|----------|-------------|
| 80-100 | Very Strong | Excellent security, hard to crack |
| 60-79 | Strong | Good security for most uses |
| 40-59 | Moderate | Acceptable but could be improved |
| 20-39 | Weak | Easy to crack, needs improvement |
| 0-19 | Very Weak | Extremely vulnerable |

## Utility Methods

```javascript
// Run built-in strength tests
...
```javascript
// Generate password for system with symbol restrictions
...
### Browser Console
```javascript
// Copy and paste the entire code into browser console
